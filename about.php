<?php
$pageTitle = "About Us - Vdownloader";
$pageDesc = "Learn more about Vdownloader, our mission, and what we do.";
?>
<!DOCTYPE html>
...
<body>
    ...
    <section class="page-header">
        <div class="container">
            ...
            <p class="lead">Simplifying video downloads for everyone around the world.</p>
        </div>
    </section>
    ...
    <section class="container mt-5 mb-5 pb-5">
        <div class="row justify-content-center">
            <div class="col-md-10 text-center">
                <div class="mb-5">
                    <i class="fas fa-rocket fa-4x mb-4 text-primary"></i>
                    <h2 class="fw-bold" style="color: var(--text-color);">Our Mission</h2>
                    <p class="lead text-muted mx-auto" style="max-width: 700px;">
                        At Vdownloader, we believe that accessing media offline shouldn't be a complicated process. Our
                        mission is to provide the fastest, most reliable, and easiest-to-use platform for downloading
                        videos from your favorite social media websites natively in high quality—completely free.
                    </p>
                </div>
            </div>
            <div class="col-md-5 mb-4">
                <div class="bg-light rounded-4 p-5 shadow-sm h-100"
                    style="background: var(--card-bg) !important; color: var(--text-color);">
                    <h4><i class="fas fa-bolt text-warning me-2"></i> Lightning Fast</h4>
                    <p class="text-muted mt-3">We utilize optimized servers to fetch and distribute files as quickly as
                        technically possible. No waiting times, just instantly processed downloads whenever you need
                        them.</p>
                </div>
            </div>
            <div class="col-md-5 mb-4">
                <div class="bg-light rounded-4 p-5 shadow-sm h-100"
                    style="background: var(--card-bg) !important; color: var(--text-color);">
                    <h4><i class="fas fa-shield-alt text-success me-2"></i> 100% Secure</h4>
                    <p class="text-muted mt-3">Your privacy is crucial. We do not require account registration, and we
                        do not track or save your download history natively on our servers. What you download is
                        entirely your own business.</p>
                </div>
            </div>
        </div>
    </section>
